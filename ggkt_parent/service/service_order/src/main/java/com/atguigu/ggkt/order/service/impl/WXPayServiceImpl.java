...
import com.atguigu.ggkt.utils.utils.HttpClientUtils;
...
public class WXPayServiceImpl implements WXPayService {
    ...
    public Map<String, Object> createJsapi(String orderNo) {
        ...
        //1、设置参数
        paramMap.put("appid", "wxf913bfa3a2c7eeeb");//wxb3b2155b6c63503d  我的
        ...
        /*设置参数值当前微信用户openid
        实现逻辑:第一步根据订单号获取userid第二步根据userid获取openid

        因为当前使用测试号，测试号不支持支付功能，为了使用正式服务号进行测试，使用下面写法获取正式服务号微信openid
